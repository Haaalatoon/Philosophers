...
int init_data(t_data *data)
{
    ...
    // Allocate fork states array for manager
    ...
    // Initialize fork mutexes and states
    i = 0;
    ...
    while (i < data->num_philosophers)
    {
        ...
        data->philosophers[i].gate_flag = 0;    // Start with no permission
        data->philosophers[i].done_flag = 0;    // Not done initially
        data->philosophers[i].data = data;      // Link to shared data
        i++;
    }
